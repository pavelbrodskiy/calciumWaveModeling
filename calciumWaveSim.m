...
% Edited Nick Contento, Univ. Notre Dame, starting 08.12.2016
...
function [ outputFlag, frequency, amplitude, width ] = calciumWaveSim (varargin)
...
%
% OUTPUTS: The simulation will run once, then output a frequency, amplitude,
